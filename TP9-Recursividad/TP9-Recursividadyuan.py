...
numero_decimal = int(input("Ingrese un número entero positivo en decimal: "))
if numero_decimal < 0:
...
palabra_input = input("Ingrese una palabra sin espacios ni tildes: ").lower()
...
numero_input = int(input("Ingrese un número entero positivo: "))
digito_input = int(input("Ingrese un dígito (0-9) para contar: "))
if numero_input < 0 or digito_input < 0 or digito_input > 9:
    print("Por favor, ingrese un número entero positivo y un dígito entre 0 y 9.")
else:
    cantidad = contar_digito(numero_input, digito_input)
    print(f"El dígito {digito_input} aparece {cantidad} veces en el número {numero_input}.")
